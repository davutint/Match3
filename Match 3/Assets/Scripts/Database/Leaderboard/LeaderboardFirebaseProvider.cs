...
{        
    ...
    public override void SetScore(string username, int score)//point kısmını firebase data kodlarına eklemen lazım, xp sistemi ile sanırım  bunu bağlayabiliriz
    {
