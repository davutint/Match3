...
public class RoundManager : MonoBehaviour
{
	...
	[SerializeField]private CharacterExpDataManager characterExpDataManager;
	void Awake()
	{
	...
	private void WinCheck()//burada yıldız mevzusunu atıp level unlocka refactor edeceğim
	{
		...
		characterExpDataManager.SetFireBaseLevelUpAndExperience();//karaktere xp veriyoruz ve leveli duruma göre arttırıyoruz
