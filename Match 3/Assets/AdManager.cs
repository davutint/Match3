...
public class AdManager : MonoBehaviour
{
 ...
 string appKey="unexpecred_platform"; 
	...
	private void Awake()
	{
		...
		instance = this;
		if(PlayerPrefs.GetInt("isAdsActive",1)==1)//reklam kapatma satın alınıp alınmadığı kontrol ediliyor, alınmamışsa reklamlar initial ediliyor
		{
			InitializeAds();
		}
	...
	void RewardedVideoOnAdClosedEvent(IronSourceAdInfo adInfo)
	{
		...
		_theBoard.ShuffleBoard();//bu görsel birşey olduğu için oyuncu reklamı komple kapattığında bu gerçekleşmeli
	...
	{
		Debug.Log("The Ad Was Seen And The Reward Was Given");
